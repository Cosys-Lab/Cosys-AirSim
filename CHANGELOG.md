...
* Highly efficient [NoDisplay view mode](https://github.com/Cosys-Lab/Cosys-AirSim/blob/main/docs/settings.md#viewmode) to turn off main screen rendering so you can capture images at high rate

...
### Windows
* [Build it](https://cosys-lab.github.io/build_windows/)

### Linux
* [Build it](https://cosys-lab.github.io/build_linux/)
...
Note that you can use [SimMode setting](https://cosys-lab.github.io/settings/) to specify the default vehicle or the new [ComputerVision mode](https://cosys-lab.github.io/image_apis/) so you don't get prompted each time you start AirSim.

[More details](https://cosys-lab.github.io/apis/)
...
[More details](https://cosys-lab.github.io/image_apis/)
...
- [Reinforcement Learning with AirSim](https://cosys-lab.github.io/reinforcement_learning/) by Ashish Kapoor

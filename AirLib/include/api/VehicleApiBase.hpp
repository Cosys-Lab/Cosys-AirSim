    ...
    */
    ...
    virtual MarLocUwbReturnMessage getUWBData(const std::string& sensor_name) const
    {
        ...
        /*for (std::vector<MarLocUwbRange>::iterator it = uwbRanges.begin(); it != uwbRanges.end(); ++it) {
            ...
            toReturn.mur_anchorPosX.push_back(it->anchorPosX);
            toReturn.mur_anchorPosY.push_back(it->anchorPosY);
            toReturn.mur_anchorPosZ.push_back(it->anchorPosZ);
        ...
        for (std::vector<MarLocUwbRangeArray>::iterator it = uwbRangesArray.begin(); it != uwbRangesArray.end(); ++it) {
            ...
            toReturn.mura_tagPosX.push_back(it->tagPosX);
            toReturn.mura_tagPosY.push_back(it->tagPosY);
            toReturn.mura_tagPosZ.push_back(it->tagPosZ);

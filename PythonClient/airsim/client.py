...
class VehicleClient:
    ...
    def addDrawableShapePoint(self, request, shape_name, reference_frame_link, x, y, z, size, color_r, color_g, color_b,
                              color_a):
    ...
    def addDrawableShapeSphere(self, request, shape_name, reference_frame_link, x, y, z, radius, thickness,
                               number_of_segments, color_r, color_g, color_b, color_a):
    ...
    def addDrawableShapeCircle(self, request, shape_name, reference_frame_link, x, y, z, normal_x, normal_y, normal_z,
                               radius, thickness, number_of_segments, color_r, color_g, color_b, color_a):
        shape_params = [x, y, z, normal_x, normal_y, normal_z, radius, thickness, number_of_segments, color_r, color_g,
                        color_b, color_a]
    ...
    def addDrawableShapeBox(self, request, shape_name, reference_frame_link, x, y, z, extents_x, extents_y, extents_z,
                            thickness, color_r, color_g, color_b, color_a):
    ...
    def addDrawableShapeLine(self, request, shape_name, reference_frame_link, start_x, start_y, start_z, end_x, end_y,
                             end_z, thickness, color_r, color_g, color_b, color_a):
    ...
    def simGetPose(self):
        logging.warning(
            "simGetPose API is renamed to simGetVehiclePose. Please update your code." + self.upgrade_api_help)
        return self.simGetVehiclePose()

    def simSetPose(self, pose, ignore_collison):
        logging.warning(
            "simSetPose API is renamed to simSetVehiclePose. Please update your code." + self.upgrade_api_help)
        return self.simSetVehiclePose(pose, ignore_collison)

    def getCollisionInfo(self):
        logging.warning(
            "getCollisionInfo API is renamed to simGetCollisionInfo. Please update your code." + self.upgrade_api_help)
        return self.simGetCollisionInfo()

    def getCameraInfo(self, camera_id):
        logging.warning(
            "getCameraInfo API is renamed to simGetCameraInfo. Please update your code." + self.upgrade_api_help)
        return self.simGetCameraInfo(camera_id)

    def setCameraOrientation(self, camera_id, orientation):
        logging.warning(
            "setCameraOrientation API is renamed to simSetCameraOrientation. Please update your code." + self.upgrade_api_help)
        return self.simSetCameraOrientation(camera_id, orientation)

    def getPosition(self):
        logging.warning(
            "getPosition API is deprecated. For ground-truth please use simGetGroundTruthKinematics() API." + self.upgrade_api_help)
        return self.simGetGroundTruthKinematics().position

    def getVelocity(self):
        logging.warning(
            "getVelocity API is deprecated. For ground-truth please use simGetGroundTruthKinematics() API." + self.upgrade_api_help)
        return self.simGetGroundTruthKinematics().linear_velocity

    def getOrientation(self):
        logging.warning(
            "getOrientation API is deprecated. For ground-truth please use simGetGroundTruthKinematics() API." + self.upgrade_api_help)
    ...
    def getGpsLocation(self):
        logging.warning(
            "getGpsLocation API is deprecated. For ground-truth please use simGetGroundTruthKinematics() API." + self.upgrade_api_help)
...
class UrdfBotClient(VehicleClient, object):
    ...
    def updateControlledMotionComponentControlSignal(self, update_controlled_motion_component_control_signal_obj,
                                                     vehicle_name=''):
        self.client.call('updateControlledMotionComponentControlSignal',
                         update_controlled_motion_component_control_signal_obj, vehicle_name)

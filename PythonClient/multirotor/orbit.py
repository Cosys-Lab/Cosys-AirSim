...
class OrbitNavigator:
    def __init__(self, radius=2, altitude=10, speed=2, iterations=1, center=None, snapshots=None):
        self.radius = radius
        self.altitude = altitude
        self.speed = speed
        self.iterations = iterations
        self.center = [1, 0] if center is None else center
        ...
        if self.takeoff:
            ...
            if z < self.home.z_val:
                ...
                self.client.moveToPositionAsync(
                    start.x_val, start.y_val, self.home.z_val - 5, 2
                ).join()
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--speed", type=float, help="speed of orbit (in meters/second)", default=3
    )
    arg_parser.add_argument(
        "--center",
    ...
    arg_parser.add_argument(
        "--iterations",
        type=float,
        help="number of 360 degree orbits (default 3)",
        default=3,
    )
    arg_parser.add_argument(
        "--snapshots",
        type=float,
        help="number of FPV snapshots to take during orbit (default 0)",
        default=0,
    )

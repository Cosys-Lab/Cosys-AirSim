...
data_generator = DriveDataGenerator(rescale=1.0 / 255.0, horizontal_flip=False, brighten_range=0.4)
...
img_stack = Dense(1, name="output", activation=out_activation, kernel_initializer="he_normal")(
    img_stack
)
...
checkpoint_filepath = os.path.join(
    MODEL_OUTPUT_DIR,
    "fresh_models",
    "{}_model.{}-{}.h5".format("model", "{epoch:02d}", "{val_loss:.7f}"),
)

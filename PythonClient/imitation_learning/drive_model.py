...
def get_image():
    ...
    image1d = np.frombuffer(image_response.image_data_uint8.encode(), dtype=np.uint8)
...
while True:
    ...
    # Print progress
    print(
        f"Sending steering = {received_output}, throttle = {car_controls.throttle}, prediction time = {str(end_time - start_time)}"
    )

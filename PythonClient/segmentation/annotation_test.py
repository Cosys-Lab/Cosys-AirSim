...
if __name__ == "__main__":
    ...
    responses = client.simGetImages(
        [
            airsim.ImageRequest(
                "front_center", airsim.ImageType.Annotation, False, False, "TextureTestDirect"
            )
        ]
    )
    img_rgb_string = responses[0].image_data_uint8
    ...
    responses = client.simGetImages(
        [
            airsim.ImageRequest(
                "front_center", airsim.ImageType.Annotation, False, False, "RGBTestIndex"
            )
        ]
    )
    img_rgb_string = responses[0].image_data_uint8
    ...
    responses = client.simGetImages(
        [
            airsim.ImageRequest(
                "front_center", airsim.ImageType.Annotation, False, False, "RGBTestDirect"
            )
        ]
    )
    img_rgb_string = responses[0].image_data_uint8
    ...
    responses = client.simGetImages(
        [
            airsim.ImageRequest(
                "front_center", airsim.ImageType.Annotation, False, False, "GreyscaleTest"
            )
        ]
    )
    img_rgb_string = responses[0].image_data_uint8
    ...
    responses = client.simGetImages(
        [
            airsim.ImageRequest(
                "front_center", airsim.ImageType.Annotation, False, False, "TextureTestRelativePath"
            )
        ]
    )
    img_rgb_string = responses[0].image_data_uint8

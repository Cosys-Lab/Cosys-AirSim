...
client.simPlotArrows(
    points_start=[Vector3r(x, y, 0) for x, y in zip(np.linspace(0, 10, 20), np.linspace(0, 0, 20))],
...
client.simPlotArrows(
    points_start=[
        Vector3r(x, y, -3) for x, y in zip(np.linspace(0, 10, 20), np.linspace(0, 0, 20))
    ],
    points_end=[
        Vector3r(x, y, -5) for x, y in zip(np.linspace(0, 10, 20), np.linspace(10, 20, 20))
    ],
...
client.simPlotArrows(
    points_start=[
        Vector3r(x, y, z)
        for x, y, z in zip(np.linspace(0, 10, 20), np.linspace(0, 0, 20), np.linspace(-3, -10, 20))
    ],
    points_end=[
        Vector3r(x, y, z)
        for x, y, z in zip(np.linspace(0, 10, 20), np.linspace(10, 20, 20), np.linspace(-5, -8, 20))
    ],
...
client.simPlotArrows(
    points_start=[
        Vector3r(x, y, -2) for x, y in zip(np.linspace(0, 10, 20), np.linspace(0, 20, 20))
    ],
...
client.simPlotPoints(
    points=[Vector3r(x, y, -5) for x, y in zip(np.linspace(0, -10, 20), np.linspace(0, -20, 20))],
    color_rgba=[1.0, 0.0, 0.0, 1.0],
    size=25,
    duration=20.0,
    is_persistent=False,
...
client.simPlotPoints(
    points=[
        Vector3r(x, y, z)
        for x, y, z in zip(np.linspace(0, -10, 20), np.linspace(0, -20, 20), np.linspace(0, -5, 20))
    ],
...
client.simPlotPoints(
    points=[
        Vector3r(x, y, z)
        for x, y, z in zip(np.linspace(0, 10, 20), np.linspace(0, -20, 20), np.linspace(0, -7, 20))
    ],
    color_rgba=[1.0, 0.0, 1.0, 1.0],
    size=15,
    duration=20.0,
...
client.simPlotLineStrip(
    points=[Vector3r(x, y, -5) for x, y in zip(np.linspace(0, -10, 10), np.linspace(0, -20, 10))],
    color_rgba=[1.0, 0.0, 0.0, 1.0],
    thickness=5,
    duration=30.0,
    is_persistent=False,
...
client.simPlotLineList(
    points=[Vector3r(x, y, -7) for x, y in zip(np.linspace(0, -10, 10), np.linspace(0, -20, 10))],
    color_rgba=[1.0, 0.0, 0.0, 1.0],
    thickness=5,
    duration=30.0,
    is_persistent=False,
...
client.simPlotStrings(
    ...
    positions=[Vector3r(x, y, -1) for x, y in zip(np.linspace(0, 5, 5), np.linspace(0, 0, 5))],
    scale=1,
    color_rgba=[1.0, 1.0, 1.0, 1.0],
    duration=1200.0,
)
...
client.simPlotTransformsWithNames(
    poses=[
        ...
        for x, y, yaw in zip(
            np.linspace(0, 10, 10), np.linspace(0, 0, 10), np.linspace(0, np.pi, 10)
        )
    ],
...
client.simPlotTransformsWithNames(
    poses=[
        ...
        for x, y, roll in zip(
            np.linspace(0, 10, 10), np.linspace(1, 1, 10), np.linspace(0, np.pi, 10)
        )
    ],
    names=["tf_roll_" + str(idx) for idx in range(10)],
    tf_scale=35,
    tf_thickness=5,
    text_scale=1,
    text_color_rgba=[1.0, 1.0, 1.0, 1.0],
...
client.simPlotTransformsWithNames(
    ...
    names=["tf_pitch_" + str(idx) for idx in range(10)],
    tf_scale=35,
    tf_thickness=5,
    text_scale=1,
    text_color_rgba=[1.0, 1.0, 1.0, 1.0],

# Upgrading to Unreal Engine 4.22
...
3. Follow step 1 and 2 to [install Unreal Engine 4.22](https://cosysgit.uantwerpen.be/sensorsimulation/airsim/-/blob/master/docs/build_linux.md#install-and-build).

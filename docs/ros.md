...
Rviz is a useful visualization tool that can display the published data. Rviz configuration files can be found in _AirSim/ros/python_ws/src/airsim/rviz_.

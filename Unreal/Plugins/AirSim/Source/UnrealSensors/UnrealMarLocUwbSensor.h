...
private:
	...
	int traceDirection(FVector trace_start_position, FVector trace_end_position, TArray<UWBHit> *UWBHitLogfloat, float traceRayCurrentDistance, float traceRayCurrentbounces, float traceRayCurrentSignalStrength, bool drawDebug);
